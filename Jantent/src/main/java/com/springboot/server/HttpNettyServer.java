...
import com.springboot.server.handler.HttpNettyServerInitializer;
import com.springboot.util.PortChecker;
        ...
        startThread = new Thread(){
            ...
            public void run(){
                try {
                    ...
                    logger.info("HTTP com.springboot.service start success ---"+adInfo);
